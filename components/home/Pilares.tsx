...
const PILARES: readonly Pilar[] = [
  {
    ...
    texto: "Ingredientes de productores uruguayos certificados por el MGAP.",
    Icono: IconoHoja,
  },
  {
    titulo: "Cero plástico",
    texto: "Envasamos en vidrio retornable. No generamos basura plástica.",
    Icono: IconoBotella,
  },
  {
    titulo: "Cero residuo",
...
export function Pilares() {
  return (
    <section aria-labelledby="pilares-titulo" className="panel reveal bg-white">
      <div className="mx-auto w-full max-w-6xl px-5 py-20 sm:px-8">
        <h2 id="pilares-titulo" className="font-display text-3xl sm:text-4xl">
          Por qué existimos
        </h2>
        ...
        <p className="mt-14 max-w-3xl text-lg leading-relaxed">
